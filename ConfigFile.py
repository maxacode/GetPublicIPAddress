...
def createINI():
    ...
    database['Run Every X Minute(s)'] = input('Run This Script every X amount of minutes \n    (Enter "10" for 10min or "90" for 1.5 hrs - Default "20": ') or '20'
    #print( database['Run Every X Minute(s)'] )
    #print(int(database['Run Every X Minute(s)']))
